...
```{r}
py_run_file("_vcf_function_definitions.py")
```
...
all .gz files are compressed .vcf are a specially laid out text file



```{python}
vcf_gz_file = my_vcf_gz_file
vcf_name = "my_vcf.vcf"
csv_file = "my_snps.csv"
#'''This code processes a vcf.gz file using the gzip and shutil packages.gzip is used to unpackage the .gz compressed file format.  (shutil provides file handling functions.'''
# Processing cell 1
import gzip
import shutil
